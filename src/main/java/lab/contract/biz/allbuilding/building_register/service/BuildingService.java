...
import lab.contract.biz.allbuilding.building_register.persistence.repository.BuildingRepository;
...
public class ContractService {
    ...
    private static final String UPLOAD_PATH = "C:/biz/building/getpdf/";
    ...
    public Long saveContract(
        ...
        Contract saveContract = Contract.builder()
                ...
                .build();
        return buildingRepository.save(saveContract).getId();
    }
