...
public class ContractCompareService {
    ...
    public Result checkRepair(Contract contract) {
        ...
        if (specialOption.contains("수리")) {
            ...
            result.setResult(STRONG);
            int repairpair = rate(STRONG);
            System.out.println(repairpair);
